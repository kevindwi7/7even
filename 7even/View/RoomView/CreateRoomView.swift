            ...
            GeometryReader { geometry in
                ...
                List {
                    ...
                    HStack {
                        Spacer()
                        Button(action: {
                            roomViewModel.createRoom(sport: sportName, location: location.name, region: location.region, minimumParticipant: Int(minimumParticipant) ?? 0, maximumParticipant: Int(maximumParticipant) ?? 0, price: Decimal(Int(price) ?? 0), isPrivateRoom: isPrivateRoom, startTime: startTime, endTime: endTime, sex: sex, age: age, levelOfPlay: levelOfPlay)
